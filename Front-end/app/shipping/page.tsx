          ...
          <div className="bg-gray-800/50 rounded-lg p-8 space-y-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  All services provided by CareerForge AI are digital. No physical products will be shipped.
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  We deliver our services through multiple channels to ensure you receive everything you need:
                </p>
                <ul className="text-gray-300 space-y-2 ml-4">
                  <li>• <strong>Web Platform:</strong> Access all features through your dashboard</li>
                  <li>• <strong>Email Notifications:</strong> Receive updates and reports via email</li>
                  <li>• <strong>Mobile App:</strong> Use our mobile application for on-the-go access</li>
                  <li>• <strong>API Access:</strong> Enterprise users can integrate via API</li>
                </ul>
              </div>
            </div>
