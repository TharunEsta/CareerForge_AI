    ...
    <div className="min-h-screen flex bg-gray-50">
      <aside className="hidden md:block w-64 bg-white border-r shadow-sm flex flex-col py-8 px-4">
        ...
        <nav className="flex-1 space-y-2">
          ...
          <a href="/dashboard/job-matching" className="flex items-center gap-3 px-3 py-2 rounded-lg text-blue-700 bg-blue-100 font-medium transition">🎯 Job Matching</a>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {matchResults && (
            <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="mt-6">
                <h3 className="text-lg font-semibold mb-3 text-blue-700">💡 Suggestions for Improvement</h3>
                <ul className="space-y-2">
