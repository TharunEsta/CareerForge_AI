...
export default function DashboardPage() {
  ...
  const [recentActivity, setRecentActivity] = useState([
    ...
    { id: 2, type: 'job-match', action: 'Job match analyzed', time: '1 day ago', status: 'completed' },
    { id: 3, type: 'cover-letter', action: 'Cover letter generated', time: '3 days ago', status: 'completed' },
    { id: 4, type: 'linkedin', action: 'LinkedIn profile optimized', time: '1 week ago', status: 'completed' }
  ]);
    ...
    <div className="min-h-screen flex bg-gray-50">
      <aside className="hidden md:block w-64 bg-white border-r shadow-sm flex flex-col py-8 px-4">
        ...
        <nav className="flex-1 space-y-2">
          <a href="/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-lg text-blue-700 bg-blue-100 font-medium transition">🏠 Dashboard</a>
          ...
          <a href="/tools" className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 font-medium transition">🛠️ AI Tools</a>
          <a href="/voice-assistant" className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 font-medium transition">🎤 Voice Assistant</a>
          <a href="/agent" className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 font-medium transition">🤖 AI Agent</a>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 border border-gray-200 rounded-lg hover:border-blue-300 transition">
                ...
                <p className="text-sm text-gray-600">AI-powered resume parsing and skill extraction</p>
              </div>
              ...
              <div className="p-4 border border-gray-200 rounded-lg hover:border-green-300 transition">
                ...
                <p className="text-sm text-gray-600">Intelligent job-resume matching with skill analysis</p>
              </div>
