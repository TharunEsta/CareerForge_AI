...
export default function LinkedInOptimizationPage() {
  ...
  const [profileData, setProfileData] = useState({ keywords: "", 
    headline: '',
    summary: '',
    experience: '',
    skills: '',
          ...
          improvements: [
            {
              ...
              suggested:
                'Senior Software Engineer | Full-Stack Development | React & Node.js | AWS',
            ...
            },
            {
              ...
              suggested:
                'JavaScript, React, Node.js, TypeScript, AWS, Docker, CI/CD, REST APIs, GraphQL, MongoDB, PostgreSQL, Agile, Scrum, Git, JIRA',
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 mb-6">
                  Get AI-powered suggestions to optimize your LinkedIn profile for better visibility
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex items-center bg-blue-100 px-3 py-1 rounded-full">
                      <span className="text-blue-800 font-medium">
                        {optimizationResults.score}% Optimized
                      </span>
                    </div>
                  </div>
                  <button
        ...
        keywords: "",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {optimizationResults.keywordAnalysis.strong.map(
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {optimizationResults.keywordAnalysis.missing.map(
                        (keyword: string, index: number) => (
                          <span
                            key={index}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {optimizationResults.keywordAnalysis.suggested.map(
                        (keyword: string, index: number) => (
                          <span
                            key={index}
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-3">
                  {optimizationResults.recommendations.map(
