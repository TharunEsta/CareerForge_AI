            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Yes, we provide comprehensive technical support for all our services and features.
                  </p>
                </div>
                <div>
                  <h3 className="text-white font-semibold mb-2">Can I get a refund?</h3>
                  <p className="text-gray-400 text-sm">
                    Please refer to our refund policy for detailed information about our refund terms.
                  </p>
                </div>
                <div>
