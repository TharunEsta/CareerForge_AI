...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "Click on the 'Resume Analysis' card on the dashboard or drag and drop your PDF, DOC, or DOCX file into the upload area. Our AI will automatically parse and analyze your resume.",
    category: 'Getting Started',
  },
  {
    question: 'What file formats are supported?',
    answer:
      'We support PDF, DOC, and DOCX files. For best results, we recommend using PDF format as it preserves formatting better.',
    category: 'Getting Started',
  },
  {
    question: 'How does job matching work?',
    answer:
      'After uploading your resume, our AI analyzes your skills and experience to find relevant job opportunities. You can also manually search for jobs based on your criteria.',
    category: 'Features',
  },
  {
    question: 'Can I upgrade my plan anytime?',
    answer:
      "Yes, you can upgrade or downgrade your plan at any time. Changes take effect immediately and you'll only be charged for the difference.",
    category: 'Billing',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, we use industry-standard encryption and security measures to protect your data. We never share your personal information with third parties.',
    category: 'Security',
  },
  {
    question: 'How accurate is the AI analysis?',
    answer:
      'Our AI is trained on millions of resumes and job descriptions, providing highly accurate analysis. However, we always recommend reviewing and customizing the results.',
    category: 'Features',
  },
];
    ...
    <div className="min-h-screen bg-[#18181b] py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            Find answers to common questions and get the support you need to make the most of
            CareerForge AI.
          </motion.p>
        </div>
