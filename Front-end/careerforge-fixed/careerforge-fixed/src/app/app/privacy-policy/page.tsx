    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">Your privacy is our priority</p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  CareerForge AI ("we," "our," or "us") is committed to protecting your privacy. We
                  collect personal information such as name, email, phone number, and resume data
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  ...
                  and only used for your interactions on our platform. We implement
