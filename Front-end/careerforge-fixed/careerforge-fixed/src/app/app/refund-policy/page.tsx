    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Cancellation and Refund Policy</h1>
          <p className="text-gray-400 text-lg">Understanding our refund and cancellation terms</p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          <div className="bg-gray-800/50 rounded-lg p-8 space-y-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  We offer digital services which are delivered instantly or within a short
                  processing window. Therefore, payments made for AI-generated resume analysis, job
                  matching, or learning plans are <strong>non-refundable</strong> once the service
                  has been delivered.
                </p>
                <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                  <p className="text-orange-300 text-sm">
                    ⚠️ Due to the digital nature of our services, refunds are limited to specific
                    circumstances only.
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  If you are dissatisfied with the service or made a payment in error, contact us at
                  support@careerforge.info within 24 hours. We will evaluate cases on an individual
                  basis.
                </p>
            ...
            <div className="border-t border-gray-700 pt-6">
              ...
              <p className="text-gray-400 text-sm mt-2">
                This refund policy is effective as of the date listed above and will remain in
