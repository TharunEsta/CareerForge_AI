      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Start your career journey with our AI-powered tools. All plans include a 7-day free
            trial.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gray-800 rounded-lg p-1 flex items-center">
            <Button
              ...
              className={
                billingCycle === 'monthly' ? 'bg-blue-600' : 'text-gray-400 hover:text-white'
            >
              Monthly
            </Button>
            <Button
              ...
              className={
                billingCycle === 'yearly' ? 'bg-blue-600' : 'text-gray-400 hover:text-white'
            >
              Yearly
              {billingCycle === 'yearly' && (
        ...
        >
          {plans.map((plan, index) => {
            ...
            const displayPrice =
              plan.id === 'free' ? 0 : isYearly ? getYearlyPrice(plan.price) : plan.price;
                  ...
                  <CardHeader>
                    ...
                    {isYearly && plan.id !== 'free' && (
                      <div className="flex items-center gap-2 mt-2">
                        <Badge className="bg-green-600 text-xs">Save ₹{savings.toFixed(0)}</Badge>
                        <span className="text-gray-400 text-sm">vs monthly billing</span>
                      </div>
                    )}
                  </CardHeader>
                  <CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card className="border-gray-700">
              <CardContent className="p-6">
                ...
                <p className="text-gray-400 text-sm">
                  We accept UPI, credit/debit cards, net banking, and digital wallets like Paytm and
                  PhonePe.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-700">
              <CardContent className="p-6">
                ...
                <p className="text-gray-400 text-sm">
                  We offer a 7-day money-back guarantee. If you're not satisfied, contact our
                  support team.
                </p>
              </CardContent>
            </Card>
