...
export default function DashboardPage() {
  ...
  const simulateTyping = async (response: string) => {
    ...
    for (let i = 0; i < words.length; i++) {
      ...
      setMessages((prev) =>
        prev.map((msg) => (msg.id === 'typing' ? { ...msg, content: displayedText.trim() } : msg))
      );
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-800">
        <div>
          ...
          <p className="text-gray-400 text-sm">
            Your AI-powered career assistant. Ask me anything about resumes, job matching, or career
            advice.
          </p>
        </div>
      </div>
            ...
            {messages.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 mb-8 max-w-md mx-auto">
                  Your AI-powered career assistant. Ask me anything about resumes, job matching, or
                  career advice.
                </p>
                {/* Feature Cards */}
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">
                          Upload and analyze your resume for ATS optimization
                        </p>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">
                          Find matching job opportunities based on your skills
                        </p>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="space-y-6">
                <AnimatePresence>
                  {messages.map((message) => (
                    ...
                    >
                      <div
                        className={`max-w-3xl ${message.role === 'user' ? 'order-2' : 'order-1'}`}
                      >
                        <div
