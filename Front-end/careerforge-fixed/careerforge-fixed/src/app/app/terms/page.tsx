          ...
          <div className="bg-gray-800/50 rounded-lg p-8 space-y-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  By accessing and using CareerForge AI, you agree to comply with our terms. Our
                  platform offers services like resume parsing, job matching, AI-based scoring, and
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  Subscription terms and payment processing are handled through secure payment
                  gateways.
                </p>
                <ul className="text-gray-300 space-y-2 ml-4">
